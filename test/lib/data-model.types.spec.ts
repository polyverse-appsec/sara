...
describe(`Data Model Schema Validation`, function () {
    describe(`'BaseSaraObjectSchema' Validation`, function () {
        it(`Fails if 'id' is missing`, function () {
            ...
            const validationError = BaseSaraObjectSchema.validate(baseSaraObject).error
        ...
        it(`Fails if 'id' is the empty string`, function () {
            ...
            expect(validationError).to.exist
            expect(validationError?.message).to.exist
            expect(validationError?.message).to.equal(`"id" is not allowed to be empty`)
        })
        ...
        it(`Fails if 'createdAt' is 'null'`, function () {
            ...
            expect(validationError).to.exist
            expect(validationError?.message).to.exist
            expect(validationError?.message).to.equal(`"createdAt" must be a valid date`)
        })
        ...
        it(`Fails if 'createdAt' isn't a date`, function () {
            ...
            expect(validationError).to.exist
            expect(validationError?.message).to.exist
            expect(validationError?.message).to.equal(`"createdAt" must be in timestamp or number of milliseconds format`)
        })
        ...
        it(`Fails if 'createdAt' is below the min allowed value`, function () {
            ...
            expect(validationError).to.exist
            expect(validationError?.message).to.exist
            expect(validationError?.message).to.equal(`"createdAt" must be greater than or equal to "2023-12-25T00:00:00.000Z"`)
        })
        ...
        it(`Fails if 'createdAt' is above the max allowed value`, function () {
            ...
            expect(validationError).to.exist
            expect(validationError?.message).to.exist
            expect(validationError?.message).to.equal(`"createdAt" must be less than or equal to "now"`)
        })
        ...
        it(`Fails if 'lastUpdatedAt' is 'null'`, function () {
            ...
            expect(validationError).to.exist
            expect(validationError?.message).to.exist
            expect(validationError?.message).to.equal(`"lastUpdatedAt" must be a valid date`)
        })
        ...
        it(`Fails if 'lastUpdatedAt' isn't a date`, function () {
            ...
            expect(validationError).to.exist
            expect(validationError?.message).to.exist
            expect(validationError?.message).to.equal(`"lastUpdatedAt" must be in timestamp or number of milliseconds format`)
        })
        ...
        it(`Fails if 'lastUpdatedAt' is below the min allowed value 'createdAt' value`, function () {
            ...
            expect(validationError).to.exist
            expect(validationError?.message).to.exist
            expect(validationError?.message).to.equal(`"lastUpdatedAt" must be greater than or equal to "ref:createdAt"`)
        })
        ...
        it(`Fails if 'lastUpdatedAt' is above the max allowed value`, function () {
            ...
            expect(validationError).to.exist
            expect(validationError?.message).to.exist
            expect(validationError?.message).to.equal(`"lastUpdatedAt" must be less than or equal to "now"`)
        })
    ...
    describe(`'GoalSchema' Validation`, function () {
        ...
        it(`Fails if 'orgId' is the empty string`, function () {
            ...
            expect(validationError).to.exist
            expect(validationError?.message).to.exist
            expect(validationError?.message).to.equal(`"orgId" is not allowed to be empty`)
        })
        ...
        it(`Fails if 'title' is the empty string`, function () {
            ...
            expect(validationError).to.exist
            expect(validationError?.message).to.exist
            expect(validationError?.message).to.equal(`"title" is not allowed to be empty`)
        })
        ...
        it(`Fails if 'description' is 'null'`, function () {
            ...
            expect(validationError).to.exist
            expect(validationError?.message).to.exist
            expect(validationError?.message).to.equal(`"description" must be a string`)
        })
        ...
        it(`Fails if 'description' is the empty string`, function () {
            ...
            expect(validationError).to.exist
            expect(validationError?.message).to.exist
            expect(validationError?.message).to.equal(`"description" is not allowed to be empty`)
        })
        ...
        it(`Fails if 'status' is the empty string`, function () {
            ...
            expect(validationError).to.exist
            expect(validationError?.message).to.exist
            expect(validationError?.message).to.equal(`"status" is not allowed to be empty`)
        })
        ...
        it(`Fails if 'chatId' is the empty string`, function () {
            ...
            expect(validationError).to.exist
            expect(validationError?.message).to.exist
            expect(validationError?.message).to.equal(`"chatId" is not allowed to be empty`)
        })
        ...
        it(`Fails if 'parentProjectId' is 'null'`, function () {
            ...
            expect(validationError).to.exist
            expect(validationError?.message).to.exist
            expect(validationError?.message).to.equal(`"parentProjectId" must be a string`)
        })
        ...
        it(`Fails if 'parentProjectId' is the empty string`, function () {
            ...
            expect(validationError).to.exist
            expect(validationError?.message).to.exist
            expect(validationError?.message).to.equal(`"parentProjectId" is not allowed to be empty`)
        })
        ...
        it(`Fails if 'closedAt' is 'null'`, function () {
            ...
            expect(validationError).to.exist
            expect(validationError?.message).to.exist
            expect(validationError?.message).to.equal(`"closedAt" must be a valid date`)
        })
        ...
        it(`Fails if 'closedAt' isn't a date`, function () {
            ...
            expect(validationError).to.exist
            expect(validationError?.message).to.exist
            expect(validationError?.message).to.equal(`"closedAt" must be in timestamp or number of milliseconds format`)
        })
        ...
        it(`Fails if 'closedAt' is below the min allowed value 'lastUpdatedAt' value`, function () {
            ...
            expect(validationError).to.exist
            expect(validationError?.message).to.exist
            expect(validationError?.message).to.equal(`"closedAt" must be greater than or equal to "ref:lastUpdatedAt"`)
        })
        ...
        it(`Fails if 'closedAt' is above the max allowed value`, function () {
            ...
            expect(validationError).to.exist
            expect(validationError?.message).to.exist
            expect(validationError?.message).to.equal(`"closedAt" must be less than or equal to "now"`)
        })
