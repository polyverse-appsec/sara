// 03/26/24: We have moved to a new UI/UX supported by a new data model. This
// test performed testing on an old data type and the methods that supported
// it. It is probably worth deleting but getting tests to work in the 1st place
// was time consuming so for now I am keeping the outline of this test for
...
//         expect(promise).to.be.rejectedWith(`"id" is required`),
//       ])
//     })
...
//       return Promise.all([
//         expect(promise).to.be.rejectedWith(Joi.ValidationError),
//         expect(promise).to.be.rejectedWith(`"id" must be a string`),
//       ])
//     })
...
//       return Promise.all([
//         expect(promise).to.be.rejectedWith(Joi.ValidationError),
//         expect(promise).to.be.rejectedWith(`"id" is not allowed to be empty`),
//       ])
//     })
...
//       return Promise.all([
//         expect(promise).to.be.rejectedWith(Joi.ValidationError),
//         expect(promise).to.be.rejectedWith(`"title" is required`),
//       ])
//     })
...
//       return Promise.all([
//         expect(promise).to.be.rejectedWith(Joi.ValidationError),
//         expect(promise).to.be.rejectedWith(`"title" must be a string`),
//       ])
//     })
...
//       return Promise.all([
//         expect(promise).to.be.rejectedWith(Joi.ValidationError),
//         expect(promise).to.be.rejectedWith(`"description" is required`),
//       ])
//     })
...
//       return Promise.all([
//         expect(promise).to.be.rejectedWith(Joi.ValidationError),
//         expect(promise).to.be.rejectedWith(`"description" must be a string`),
//       ])
//     })
...
//       return Promise.all([
//         expect(promise).to.be.rejectedWith(Joi.ValidationError),
//         expect(promise).to.be.rejectedWith(`"createdAt" is required`),
//       ])
//     })
...
//       return Promise.all([
//         expect(promise).to.be.rejectedWith(Joi.ValidationError),
//         expect(promise).to.be.rejectedWith(`"userId" is required`),
//       ])
//     })
...
//       return Promise.all([
//         expect(promise).to.be.rejectedWith(Joi.ValidationError),
//         expect(promise).to.be.rejectedWith(`"userId" must be a string`),
//       ])
//     })
...
//       return Promise.all([
//         expect(promise).to.be.rejectedWith(Joi.ValidationError),
//         expect(promise).to.be.rejectedWith(`"projectId" is required`),
//       ])
//     })
...
//       return Promise.all([
//         expect(promise).to.be.rejectedWith(Joi.ValidationError),
//         expect(promise).to.be.rejectedWith(`"projectId" must be a string`),
//       ])
//     })
...
//       return Promise.all([
//         expect(promise).to.be.rejectedWith(Joi.ValidationError),
//         expect(promise).to.be.rejectedWith(`"chats" must be an array`),
//       ])
//     })
...
//       return Promise.all([
//         expect(promise).to.be.rejectedWith(Joi.ValidationError),
//         expect(promise).to.be.rejectedWith(`"subtasks" must be an array`),
//       ])
//     })
...
//       return Promise.all([
//         expect(promise).to.be.rejectedWith(Joi.ValidationError),
//         expect(promise).to.be.rejectedWith(`"subtasks[0].id" is required`),
//       ])
//     })
