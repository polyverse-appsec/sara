    ...
    >
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            Delete a project and all of its associated resources (goals, tasks,
            chats).
          </DialogDescription>
        </DialogHeader>
        <div className="p-4 space-y-1 text-sm border rounded-md">
          <div className="font-medium">
            Are you sure you want to delete the project? It will also delete all
            resources associated with it such as goals, tasks, and chats.
          </div>
        </div>
