...
import { useAppContext, type SaraConfigStatuses } from './../lib/hooks/app-context'
...
export function SaraStatus() {
    const { saraConfig: { status, statusInfo, errorInfo } } = useAppContext()

    // TODO: All the icons were originally wrapped in this
