interface CopyToClipboardIconProps {
  ...
  const CopyToClipboardIcon = ({ copied, color = '' }: CopyToClipboardIconProps) => (
    copied ? (
      ...
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke={color} stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="cursor-pointer w-4 h-4 ml-2">
