...
export const ProjectConfigurationDialog = ({ projectDataReferences, open, onOpenChange, onSaveConfig }: ProjectConfigurationDialogProps) => {
    const [projectDataReferenceState, setProjectDataReferenceState] = useState(createProjectDataReferenceState(projectDataReferences))
    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent>
                ...
                <DialogDescription>
                    Add additional references to your project for learning and fine-tuning your model.
                </DialogDescription>
                </DialogHeader>
                                ...
                                <div style={{ padding: '15px 20px' }}>
                                    {
                                        Object.entries(projectDataReferenceState).map(
                                            ([key, projectDataReference]) => (
                                                <div className="py-1" style={{ display: 'flex', alignItems: 'center' }} key={key} >
                                                    <Checkbox.Root
                                                        ...
                                                        onCheckedChange={(checked) => {
                                                            ...
                                                            if (checked !== 'indeterminate') {
                                                                newProjectDataReferenceState[key].checked = checked
                                                            }

                                                            setProjectDataReferenceState(newProjectDataReferenceState)
                                                        }}
                                                    >
                                                        <Checkbox.Indicator>
                                                            <CheckIcon />
