  ...
  return (
    <div className="flex flex-col items-center justify-center p-4">
      <Image
        ...
        height={200}
      />
      <p className="font-medium italic text-8xl">Introducing Sara</p>
      ...
      <div className="mt-4 p-4 border-2 border-blue-600 rounded-lg text-base text-center text-gray-700">
