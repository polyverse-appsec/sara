        ...
        <div className="flex flex-col items-center p-10">
          ...
          <RenderableResourceContent>
            <div className="flex flex-col items-center text-center">
                ...
                <p className="mt-1 italic">If you do not authorize Sara to access your private repos, you will not be able to manage your private repos with Sara</p>
                { userGitHubAppInstalled ? <p className="font-bold">Sara has access to your private repos ✅</p> : <p className="font-bold">Sara does not have access to your private repos 🛑</p> }
                ...
                <p className="text-xs text-blue-600 mt-2">Note, this will redirect you to the Github</p>
            </div>
          </RenderableResourceContent>
        </div>
