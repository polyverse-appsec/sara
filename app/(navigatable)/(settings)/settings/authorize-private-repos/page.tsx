          ...
          <div className="mt-2 w-full">
            <CollapsibleRenderableResourceContent title="Instructions for Installing">
              <div className="flex flex-col items-start">
                ...
                <p>2. Click on the configure button</p>
                <p>
                  3. Click on the button labeled with the org you want to
                  authorize repo access for
                </p>
                <p>4. Click on the install app button</p>
                <p>
                  Note: The admins of the org are allowed to install apps so if
                  you are not the admin you must press the request to install
                  button and notify your org admin
                </p>
              </div>
            </CollapsibleRenderableResourceContent>
          </div>
