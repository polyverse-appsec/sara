  ...
  return (
    <div className="flex flex-col items-center p-10">
      ...
      <RenderableResourceContent>
        ...
        <p className="mt-4">
          Once you select an org to upgrade, you will be redirected to the page
          where you can proceed with upgrading it
        </p>
        <p className="mt-2">
          If you do not see your org here, you need to add it in the manage
