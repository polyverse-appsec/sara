...
export type FineTuningTags = 'FAVORITE' | 'INSIGHTFUL' | 'PRODUCTIVE' | 'UNHELPFUL'
...
export interface ChatQuery extends BaseSaraObject {
  ...
  // List of tag identifiers that users can provide to help identify/tune
  // the requests/responses they work with
  fineTuningTags: FineTuningTags[] | null
