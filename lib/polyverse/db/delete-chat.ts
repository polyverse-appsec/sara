...
import { globalChatIdsSetKey, chatKey, relatedChatQueriesToChatIdsSetKey } from './../../../lib/polyverse/db/keys'
...
const deleteChat = async (chatId: string): Promise<void> => {
    ...
    const chatQueryIds = (await kv.zrange(chatQueriesToChatIdsSetKey, 0, -1)) as string[]
