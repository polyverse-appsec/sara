...
const createPromptFileInfo = async (promptFileInfo: PromptFileInfo): Promise<void> => {
  ...
  const promptFileInfosToProjectsIdsSetKey= relatedPromptFileInfosToProjectIdsSetKey(promptFileInfo.parentProjectId)
